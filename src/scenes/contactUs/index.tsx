    ...
    <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.Contactus)}>
      ...
      <div className="mt-10 justify-between gap-8 md:flex">
        ...
        >
          ...
          target="_blank"
          onSubmit={ onSubmit }
          action="https://formsubmit.co/e4a5a78db9de4bf1febc1de4c6151db8"
          method="POST"
          >
           ...
           <input className={inputStyles}
            ...
            <button type="submit" className="mt-5 rounded-lg bg-secondary-500 px-20 py-3 tramsition duration-500 hover: text-white">
              SUBMIT
            </button>
          </form>
        </motion.div >
        ...
        >
          <div className="md:before:content-evolvetext w-full before:absolute before:-bottom-20 before:-right-10 before:z-[-1]">
            <img 
            className="w-full "
            alt="contactus-page-graphic"  src={ContactUsPageGraphic} />
          </div>
